...
import 'banner_model_entity.dart';

class HomeBanner extends StatefulWidget {
  final List<BannerModelList> bannerStories;
...
class _BannerState extends State<HomeBanner> {
  ...
  Widget _buildItem(BannerModelList bannerEntity) {
    return GestureDetector(
      ...
      child: Stack(
        fit: StackFit.expand,
        children: <Widget>[
          Image.network(bannerEntity.imgUrl, fit: BoxFit.cover),
...
typedef void OnTapBannerItem(BannerModelList bannerEntity);
